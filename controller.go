...
func (c *Controller) updateFooStatus(foo *fimv1alpha1.Foo, deployment *appsv1.Deployment) error {
	...
	_, err := c.fimclientset.FimcontrollerV1alpha1().Foos(foo.Namespace).Update(fooCopy)
	return err
}
...
func newDeployment(foo *fimv1alpha1.Foo) *appsv1.Deployment {
