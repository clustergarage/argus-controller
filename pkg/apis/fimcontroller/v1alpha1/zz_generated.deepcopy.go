...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FimWatcherIgnore) DeepCopyInto(out *FimWatcherIgnore) {
	*out = *in
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FimWatcherIgnore.
func (in *FimWatcherIgnore) DeepCopy() *FimWatcherIgnore {
	if in == nil {
		return nil
	}
	out := new(FimWatcherIgnore)
	in.DeepCopyInto(out)
	return out
}
