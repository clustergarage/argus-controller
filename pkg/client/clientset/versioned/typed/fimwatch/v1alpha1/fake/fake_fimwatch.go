...
type FakeFimWatches struct {
	Fake *FakeFimV1alpha1
	ns   string
}

var fimwatchesResource = schema.GroupVersionResource{Group: "fim.clustergarage.io", Version: "v1alpha1", Resource: "fimwatches"}

var fimwatchesKind = schema.GroupVersionKind{Group: "fim.clustergarage.io", Version: "v1alpha1", Kind: "FimWatch"}
